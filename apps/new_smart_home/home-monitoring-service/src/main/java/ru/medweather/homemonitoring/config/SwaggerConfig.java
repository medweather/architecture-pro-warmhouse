...
import ru.medweather.homemonitoring.exception.CustomExceptionResponse;
...
public class SwaggerConfig {
    ...
    public OpenAPI openAPI() {
        OpenAPI openAPI = new OpenAPI()
                .info(new Info().title("Home monitoring service"));
        if (eurekaEnabled) openAPI.setServers(List.of(
                new Server().url(apiServerUrl).description("API (home monitoring)")
        ));
        return openAPI;
    }
