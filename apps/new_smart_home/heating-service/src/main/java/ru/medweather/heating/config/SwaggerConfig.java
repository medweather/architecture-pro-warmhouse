package ru.medweather.heating.config;
...
import ru.medweather.heating.exception.CustomExceptionResponse;
...
public class SwaggerConfig {
    ...
    public OpenAPI openAPI() {
        OpenAPI openAPI = new OpenAPI()
                .info(new Info().title("Heating service"));
        if (eurekaEnabled) openAPI.setServers(List.of(
                new Server().url(apiServerUrl).description("API (heating)")
        ));
        return openAPI;
    }
