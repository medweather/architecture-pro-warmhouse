package ru.medweather.automaticgates.config;
...
import ru.medweather.automaticgates.exception.CustomExceptionResponse;
...
public class SwaggerConfig {
    ...
    public OpenAPI openAPI() {
        OpenAPI openAPI = new OpenAPI()
                .info(new Info().title("Automatic gates service"));
        if (eurekaEnabled) openAPI.setServers(List.of(
                new Server().url(apiServerUrl).description("API (automatic gates)")
        ));
        return openAPI;
    }
