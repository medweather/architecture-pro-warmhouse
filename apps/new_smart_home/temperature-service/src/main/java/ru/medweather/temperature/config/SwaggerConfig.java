...
import ru.medweather.temperature.exception.CustomExceptionResponse;
...
public class SwaggerConfig {
    ...
    public OpenAPI openAPI() {
        OpenAPI openAPI = new OpenAPI()
                .info(new Info().title("Temperature service"));
        if (eurekaEnabled) openAPI.setServers(List.of(
                new Server().url(apiServerUrl).description("API (temperature)")
        ));
        return openAPI;
    }
